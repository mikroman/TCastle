...
8356 ifpeek(v3)thengosub8741
8363 ifflthenfl=0:goto9844
8371 geta$
8373 p=peek(v4)
8376 b=(peek(jo)and16)
8381 if(((p=0)and(a$=""))and(b=16))then8356
8395 ifpthengosub8741:goto8356
8404 ifpeek(v3)then8356
8409 if(b=0)thengosub8490
8417 if(a$="")then8356
8423 if((peek(653)and4)=0)then8477
8434 if(asc(a$)=17)then10435
8441 if(asc(a$)=2)thengosub8772
8450 if(asc(a$)=19)thengosub8808
8459 if(asc(a$)=22)thengosub10763
8468 if(asc(a$)=15)thengosub10018
8477 if(asc(a$)=63)thengosub10486
8487 goto9334
8490 gosub8705
...
8945 gosub10843
8948 s$=(s$+"{$a0}{$a0}{$a0}")
8955 if(len(s$)<5)thens$=("0"+s$):goto8955
8969 z=14
8971 goto8871
...
9139 l=(len(m$)-1)
9144 m$=right$(m$,l)
9148 if(l<9)thenm$=("0"+m$):l=(l+1):goto9148
9165 return
...
9195 k=0
9197 ifbethenk=7
9202 if(be=5)thenk=13
9209 poke53288,k
9217 return
9218 be=0
9220 co=peek(165)
9224 if(co=7)thenbe=1
9231 if(co=13)thenbe=5
9238 return
9239 gosub8974
...
9429 s$=""
9431 geta$
9433 if(a$<>chr$(13))thenif(a$<>chr$(20))thenif((a$<"0")or(a$>"9"))then9431
9457 if(a$=chr$(13))then9513
9464 if((a$=chr$(20))and(s$<>""))thenprint" {left}{left}C{left}";:s$=left$(s$,(len(s$)-1))
...
9583 next
9584 fl=0
9586 if((((st(0)=st(1))and(st(1)=st(2)))and(st(2)=st(3)))and(st(3)=st(4)))thenfl=4
9621 sr=0
9624 cs(13)=cs(0)
9630 i=1
9632 fori=ito9
9636 if((((cs(i)andcs((i+1)))andcs((i+2)))andcs((i+3)))andcs((i+4)))thensr=1
9668 next
9669 j=0
9671 k=0
9673 i=0
9675 fori=ito12
9679 if(cs(i)>1)thenk=(-2*(j<>0)):j=cs(i)
9697 next
9698 i=0
9700 if(((flandsr)andcs(0))andcs(12))theni=250:goto9834
9720 if(flandsr)theni=50:goto9834
9732 if(j=4)theni=25:goto9834
9742 if((j=3)and(k=2))theni=9:goto9834
9756 iffltheni=6:goto9834
9764 ifsrtheni=4:goto9834
9773 if(j=3)theni=3:goto9834
9783 if((j=2)and(k=2))theni=2:goto9834
9797 if(j=0)then9834
9803 j=0
9805 forj=jto12
9809 if(cs(j)=2)thenk=j:j=12
9820 next
9821 i=1
9823 if((k<>0)and(k<10))theni=0
9834 j=0
9836 k=0
9838 fl=0
9840 sr=0
...
9844 gosub9533
9847 am=(tb*i)
9852 if(am=0)thenam=-tb
9862 if(am>0)thenpoke2,(((am/16)+1)and255):sys((ba+(16*3)))
9886 ub=int((ub+am))
9892 gosub9166
...
9920 gosub8871
9923 s$="won  $"
9931 if(am<0)thens$="lost $"
9945 tb=am
9948 gosub10843
9951 tb=0
9953 if(len(s$)<10)thens$=(s$+" "):goto9953
9967 z=30
9969 gosub8871
9972 rf=1
9975 gosub10399
...
10323 printtab(32)
10326 print"1 times"
10335 iff1thengosub9533:print"{down}{down}current hand pays $";
10365 iff1thens$=str$((tb*i)):l=len(s$):printright$(s$,(l-1))
10382 rf=1
10385 gosub10399
10388 sys((ba+6))
10393 sys(ba)
...
10399 if((peek(jo)and31)=31)thenif(peek(198)=0)then10399
10415 geta$
10417 a$=" "
10420 poke198,0
10424 ifrfthenrf=0:return
10432 goto8915
